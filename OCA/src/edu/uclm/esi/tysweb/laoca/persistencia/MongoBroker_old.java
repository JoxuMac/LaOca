...
public class MongoBroker_old {
	...
	private static class MongoBrokerHolder {
		static MongoBroker_old singleton=new MongoBroker_old();
	}
	
	public static MongoBroker_old get() {
	...
	public MongoClient getConexionPrivilegiada() {
        MongoCredential credenciales = MongoCredential.createCredential("root", MongoBroker_old.db, "root".toCharArray());
	...
	public Usuario loginUsuario(String email, String pwd) throws Exception {
		MongoClient conexion = MongoBroker_old.get().getConexionPrivilegiada();
	...
	public void registrarUsuario(Usuario usuario, String pwd) throws Exception{
		...
		try {
			...
			MongoBroker_old.get().close(conexion);
		}
	}
	...
	public boolean existeUsuario (Usuario usuario) {
		...
		MongoBroker_old broker=MongoBroker_old.get();
